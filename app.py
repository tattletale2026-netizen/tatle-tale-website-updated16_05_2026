    ...
    if request.method == 'POST':
        ...
        try:
            ...
            send_resend_email(
                ...
                to=email,
                text_body=f"Dear {first_name}, your seat has been confirmed for Workshop One.",
                html_body=user_html
            )
...
# Chapter-wise booking pages use the same booking form/email flow
