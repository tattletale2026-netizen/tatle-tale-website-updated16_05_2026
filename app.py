...
def booking():
    ...
    if request.method == 'POST':
        ...
        # Admin Email
        admin_msg = Message(
            subject='New Workshop 1 Booking (30/05/2025)',
            recipients=[MAIL_TO]
        )
        admin_msg.body = (
            "New Workshop 1 Booking (30/05/2025)\n\n"
        ...
        user_msg = Message(
            subject='Your Seat is Confirmed – Workshop 1 (30/05/2025)',
            recipients=[email]
        )
        user_msg.html = f"""
        <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; background-color: #f9fbfb; padding: 40px; border-radius: 8px; border: 1px solid #e2e8e9;">
            <div style="text-align: center; margin-bottom: 30px;">
                ...
                <p style="color: #2a8a6e; font-size: 14px; margin-top: 5px; text-transform: uppercase; letter-spacing: 1px;">Workshop 1 · 30/05/2025</p>
            </div>
            <p style="font-size: 16px; line-height: 1.6;">Dear {first_name},</p>
            <p style="font-size: 16px; line-height: 1.6;">Thank you for booking your place at Workshop 1 on 30/05/2025.</p>
